...
skip_authorize_resource  only: [:export_email,:export_database,:tradeFilter,:publicWorksFilter,:largePublicWorksFilter]
def export_email
...
#associate the selected trades to the contractors and create records in the join table
  ...
  private
    ...
    def contractor_params
      params.require(:contractor).permit(:name, :licenseNo, :licenseClass, :bondingcapacity, :firstname, :lastname, :address, :city, :state, :zipcode, :phone, :email, :trade, :comments, :logo, :fax, :certificationType, :ownershipType, :sfCertificationNumber, :sfVendorNumber, :firmSize,:bonding,:bondingLmtSngProj,:bondingLmtAgg,:document)
    end
end
