...
if params[:contractor_ids]
    ...
    if params[:commit] == "Export Database"
        contractor_csv = CSV.generate do |csv|
      csv << ["Name","License No","License Class","Bonding Capacity", "First Name", "Last Name","Address","City","State","Zip Code","Phone","Fax","Email","Trade","Certification Type","SF Certification Number","Ownership Type","SF Vendor Number","Firm Size"]
      @contractors.each do |contractor|
